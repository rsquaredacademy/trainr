...
```{r lub40a, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Data'}
...
```{r lub50a, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Data'}
# shift course interval by 3 weeks


# shift course interval by 1 year

```

```{r lub50a-solution}
# shift course interval start date by 3 weeks
int_shift(course_interval, by = weeks(3))

# shift course interval start date by 1 year
...
```{r lub11a, eval=TRUE, echo=TRUE, collapse=TRUE}
...
# compute interval in hours


# compute interval in weeks
...
```{r lub16a, eval=TRUE, echo=TRUE, collapse=TRUE}
interval(course_start, course_end) %>%
...
```{r lub17a, eval=TRUE, echo=TRUE, collapse=TRUE}
interval(course_start, course_end) %>%
