...
```{r mag1, eval=FALSE, echo=TRUE, collapse=FALSE}
head(ecom, 10)
...
```{r mag8, eval=FALSE, echo=TRUE, collapse=FALSE}
...
![](/images/pipes_string.png){width=100%}
...
```{r mag10, eval=FALSE, echo=TRUE, collapse=FALSE}
head(ecom['n_pages'], 3)
...
```{r mag23, eval=FALSE, echo=TRUE, collapse=FALSE}
head(ecom[6], 3)
...
```{r mag11, eval=FALSE, echo=TRUE, collapse=FALSE}
head(ecom$n_pages)
...
```{r mag12, eval=FALSE, echo=TRUE, collapse=FALSE}
mt <- as.list(mtcars)
...
```{r mag13, eval=FALSE, echo=TRUE, collapse=FALSE}
mt <- as.list(mtcars)
...
```{r mag14, eval=FALSE, echo=TRUE, collapse=FALSE}
mt <- as.list(mtcars)
...
```{r mag15, eval=FALSE, echo=TRUE, collapse=FALSE}
1:10 %>%
  `+`(1)
...
```{r mag16, eval=FALSE, echo=TRUE, collapse=FALSE}
1:10 %>%
  `*`(3)
...
```{r mag17, eval=FALSE, echo=TRUE, collapse=FALSE}
1:10 %>%
  `/`(2)
...
```{r mag18, eval=FALSE, echo=TRUE, collapse=FALSE}
1:10 %>%
  `^`(2)
...
```{r mag19, eval=FALSE, echo=TRUE, collapse=FALSE}
1:10 %>%
  `>`(5)
...
```{r mag20, eval=FALSE, echo=TRUE, collapse=FALSE}
1:10 %>%
  `>=`(5)
